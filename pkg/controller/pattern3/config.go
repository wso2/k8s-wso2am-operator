...
func AssignPubIngressConfigMapValues(apimanager *apimv1alpha1.APIManager, configMap *v1.ConfigMap) *ingressConfigvalues {
	ControlConfigData := configMap.Data
...
func AssignDevIngressConfigMapValues(apimanager *apimv1alpha1.APIManager, configMap *v1.ConfigMap) *ingressConfigvalues {
	ControlConfigData := configMap.Data
